...
import { Plus, Search, Pencil, Trash2, AlertTriangle, Clock, Headphones } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <SectionCard
        ...
        description="Gestão de demandas e incidentes operacionais com SLA e MTTR."
        actions={
          <>
