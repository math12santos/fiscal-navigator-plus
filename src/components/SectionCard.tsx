...
/**
 * Standard section wrapper used across all FinCore modules to bring visual
 ...
 *
 * Originated as `DpSection` in the DP module; promoted here as the
 * project-wide section primitive. `DpSection` re-exports this component
