...
import { EMPTY_PLANNING_FILTERS, type PlanningFilters } from "@/lib/planningFilters";
...
export default function PlanningBudget({
  startDate, endDate, selectedVersionId, onSelectVersion, filters = EMPTY_PLANNING_FILTERS,
}: Props) {
  return (
